...
const aboutStats = [
  { label: "Year of degree", value: "2026" },
...
const projects = [
  {
    title: "ecom",
    description: "E-commerce platform for golf gym",
    image: "/assets/ecom.webm",
    href: "https://ujjwalcod.github.io/ecommerce-website/",
  },
  
  {
    title: "two good co",
    description: "An award winning website",
    image: "/assets/twogood co.webm",
    href: "https://ujjwalcod.github.io/twogoodco/indx",
  },
];

const Skills = [
  {
    service: "Competitive Coding",
    description:
      "Enhancing the code with more optimization ",
    icon: Code2,
  },
  {
    service: "UX Design",
      ...
      <div ref={refScrollContainer}>
        ...
        >
          <div className={styles.intro}>
            ...
            >
              <span className={styles.pill}>Reactjs</span>
            ...
            <div>
              ...
              >
                An frontend website developer with a passion for
            ...
            >
              <Link href="https://github.com/ujjwalcod" passHref>
                <Button>
        ...
        <section id="about" data-scroll-section>
          ...
          >
            <span className="text-gradient clash-grotesk text-4xl xl:text-[50px]"><b>About Me</b></span>
...
As you navigate through my portfolio, you&apos;ll gain insights into my technical capabilities, problem-solving approach, and unwavering focus on career growth. Welcome to my world, where learning is a constant, and the journey towards excellence never ends!
        ...
        <div className="flex flex-col items-center  text-4xl xl:text-6xl">
          Give a view Check once!!
          <div><Link href="https://drive.google.com/file/d/1aW27OKoseud72qbuB6oU6xNWKOyyQNJF/view?usp=drivesdk" passHref>
                <Button>
                  RESUME <ChevronRight className="ml-1 h-4 w-8 text-2xl xl:text-5xl" />
                </Button>
              </Link></div></div>
            ...
            >
              <div className="flex flex-col py-6 xl:p-6">
                ...
                <p className="mt-2 tracking-tighter text-secondary-foreground">
                  these are some skill set that i know have a look.
                </p>
              </div>
              {Skills.map((service) => (
                <div
        ...
        <section id="contact" data-scroll-section className="my-64">
          ...
          >
            <h2 className="text-4xl font-medium tracking-tighter xl:text-6xl">
              Wanna{" "}
              <span className="text-gradient clash-grotesk">Contact me</span>
            </h2>
            <p className="mt-1.5 text-base tracking-tight text-muted-foreground xl:text-lg">
              I&apos;m always available for any task and learning feel free to contact me.
            </p>
            <div className="flex flex-row justify-center gap-4">
            <Link href="https://github.com/ujjwalcod" passHref>
              <Button className="mt-6">github</Button>
            </Link>
            <Link href="https://www.instagram.com/ujjwal_m23/" passHref>
              <Button className="mt-6">Insta</Button>
            </Link>
            <Link href="https://www.linkedin.com/in/ujjwal-mishra-50a66b275?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" passHref>
              <Button className="mt-6">linkedin</Button>
            </Link>
            </div>            
          </div>
        </section>
